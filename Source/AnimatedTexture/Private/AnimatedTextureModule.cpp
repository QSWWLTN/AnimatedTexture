...
DECLARE_LLM_MEMORY_STAT(TEXT("LoadGif"), STAT_LOADGIF_LLM, STATGROUP_LLMFULL);
...
{
	LLM(FLowLevelMemTracker::Get().RegisterProjectTag((int32)EAnimatedTextureLLMTag::LoadGif, TEXT("LoadGif"), GET_STATFNAME(STAT_LOADGIF_LLM), GET_STATFNAME(STAT_CustomGroupLLM), -1));
